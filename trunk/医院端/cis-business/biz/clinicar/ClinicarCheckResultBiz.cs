...
namespace cis_business.biz.clinicar
{
    public class ClinicarCheckResultBiz : SBaseBiz
    {
        ...
        public SPagintion<ClinicarCheckResult> FindByPagination(int pageNum, int pageSize, string checkNum,string itemCode)
        {
            ...
            whereSql += " and deleted=0 and check_number = ?  and item_code = ? ";
        ...
        {
            IList<ClinicarCheckResult> list = ClinicarCheckResultDao.FindByHql(" and deleted = 0 and check_number = ? and item_code = ?", new Object[] { checkNumber,itemCode }, "");
            return list;
        }
