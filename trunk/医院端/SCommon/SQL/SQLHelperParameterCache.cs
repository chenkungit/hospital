...
namespace SCommon.SUtil
{
    ...
    public sealed class SQLHelperParameterCache
    {
        ...
        #region + SQL Server 检索指定的存储过程的参数集
        ...
        /// <param name="commandText">存储过程名或SQL语句</param>
        /// <param name="commandParameters">要缓存的参数数组</param>
        public static void CacheMyParameterSet(string connectionString, string commandText, params MySqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (commandText == null || commandText.Length == 0) throw new ArgumentNullException("commandText");
        ...
        /// <param name="commandText">存储过程名或SQL语句</param>
        /// <returns>参数数组</returns>
        public static MySqlParameter[] GetMyCachedParameterSet(string connectionString, string commandText)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (commandText == null || commandText.Length == 0) throw new ArgumentNullException("commandText");
        ...
        /// <param name="spName">存储过程名</param>
        /// <returns>返回SqlParameter参数数组</returns>
        public static MySqlParameter[] GetMySpParameterSet(string connectionString, string spName)
        {
            return GetMySpParameterSet(connectionString, spName, false);
        }
        ...
        /// <param name="includeReturnValueParameter">是否包含返回值参数</param>
        /// <returns>返回SqlParameter参数数组</returns>
        public static MySqlParameter[] GetMySpParameterSet(string connectionString, string spName, bool includeReturnValueParameter)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            {
                return GetMySpParameterSetInternal(connection, spName, includeReturnValueParameter);
            }
        }
        ...
        /// <param name="spName">存储过程名</param>
        /// <returns>返回SqlParameter参数数组</returns>
        internal static MySqlParameter[] GetMySpParameterSet(MySqlConnection connection, string spName)
        {
            return GetMySpParameterSet(connection, spName, false);
        }
        ...
        /// </param>
        /// <returns>返回SqlParameter参数数组</returns>
        internal static MySqlParameter[] GetMySpParameterSet(MySqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            using (MySqlConnection clonedConnection = (MySqlConnection)((ICloneable)connection).Clone())
            {
                return GetMySpParameterSetInternal(clonedConnection, spName, includeReturnValueParameter);
            }
        }
        ...
        /// <param name="includeReturnValueParameter">是否包含返回值参数</param>
        /// <returns>返回SqlParameter参数数组</returns>
        private static MySqlParameter[] GetMySpParameterSetInternal(MySqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
