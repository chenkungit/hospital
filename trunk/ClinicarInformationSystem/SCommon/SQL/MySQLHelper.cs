...
namespace SCommon.SUtil
{
    public sealed class MySQLHelper
    {
        ...
        {
            if (command == null) throw new ArgumentNullException("MySqlCommand对象为空");
        ...
        private static void PrepareCommand(MySqlCommand command, MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, MySqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            if (transaction != null)
            {
                if (transaction.Connection == null) throw new ArgumentException("事务已回滚或提交, 请提供已打开的事务对象.", "事务异常");
        ...
        /// <returns></returns>
        public static bool TryConnectionDataBase(string connectionString)
        {
            try
            {
        ...
        /// <summary>执行指定连接字符串,类型的MySqlCommand.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定连接字符串,类型的MySqlCommand.如果没有提供参数,不返回结果.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        {
            if (string.IsNullOrEmpty(connectionString)) throw new ArgumentNullException("数据库连接串为空");
        ...
        /// <summary>执行指定连接字符串的存储过程,将对象数组的值赋给存储过程参数,此方法需要在参数缓存方法中探索参数并生成参数.
        /// </summary>
        /// <remarks>
        /// 这个方法没有提供访问输出参数和返回值.
        /// 示例:  
        ...
        {
            if (string.IsNullOrEmpty(connectionString)) throw new ArgumentNullException("数据库连接串为空");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("存储过程为空");

            // 如果存在参数值
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                // 从探索存储过程参数(加载到缓存)并分配给存储过程参数数组.
                MySqlParameter[] commandParameters = SQLHelperParameterCache.GetMySpParameterSet(connectionString, spName);
        ...
        public static int ExecuteNonQuery(MySqlConnection connection, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
        {
            ...
            if (connection == null) throw new ArgumentNullException("数据库连接对象为空");
            try
            {
            ...
            {
                throw new Exception(string.Format(ex.ToString() + " {0}", commandText));
            }
        }

        /// <summary>执行指定数据库连接对象的命令,将对象数组的值赋给存储过程参数.
        /// </summary>
        /// <remarks>
        ...
        public static int ExecuteNonQuery(MySqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                // 从缓存中加载存储过程参数
                MySqlParameter[] commandParameters = SQLHelperParameterCache.GetMySpParameterSet(connection, spName);
        ...
        /// <summary>执行带事务的MySqlCommand(指定参数).
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        {
            if (transaction == null) throw new ArgumentNullException("事务对象为空");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("事务已回滚或提交, 请提供已打开的事务对象.", "事务异常");
        ...
        /// <summary>执行带事务的MySqlCommand(指定参数值).
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值
        /// 示例:  
        ...
        public static int ExecuteNonQuery(MySqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                MySqlParameter[] commandParameters = SQLHelperParameterCache.GetMySpParameterSet(transaction.Connection, spName);
        ...
        /// <summary>执行指定数据库连接字符串的命令,返回DataTable.
        /// </summary>
        /// <param name="connectionString">一个有效的数据库连接字符串</param>
        ...
        /// <summary>执行指定数据库连接字符串的命令,直接提供参数值,返回DataTable.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值.
        /// 示例: 
        ...
        /// <summary>执行指定数据库连接对象的命令,返回DataTable.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接对象的命令,指定参数值,返回DataTable.
        /// </summary>
        /// <remarks>
        ...
        {
            if (connection == null) throw new ArgumentNullException("数据库连接串不能为空");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("参数值不能为空");
        ...
        /// <remarks>
        /// 示例:  
        ///  DataTable dt = ExecuteDataTable(connection, CommandType.StoredProcedure, "GetOrders", new MySqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">一个有效的数据库连接对象</param>
        /// <param name="commandType">命令类型 (存储过程,命令文本或其它)</param>
        /// <param name="commandText">存储过程名或T-SQL语句</param>
        ...
        /// <summary>执行指定事务的命令,指定参数值,返回DataTable.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输入参数和返回值.
        /// 示例.:  
        ...
        /// <summary>执行指定事务的命令,指定参数,返回DataTable.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        #endregion ExecuteDataTable命令结束

        #region ExecuteDataset方法

        /// <summary>执行指定数据库连接字符串的命令,返回DataSet.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接字符串的命令,直接提供参数值,返回DataSet.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值.
        /// 示例: 
        ...
        /// <summary>执行指定数据库连接对象的命令,指定存储过程参数,返回DataSet.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接对象的命令,指定参数值,返回DataSet.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输入参数和返回值.
        /// 示例.:  
        ...
        /// <summary>执行指定事务的命令,指定参数,返回DataSet.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定事务的命令,指定参数值,返回DataSet.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输入参数和返回值.
        /// 示例.:  
        ...
        /// <summary>枚举,标识数据库连接是由MySQLHelper提供还是由调用者提供
        /// </summary>
        ...
        private static MySqlDataReader ExecuteReader(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, MySqlParameter[] commandParameters, SqlConnectionOwnership connectionOwnership)
        {
            ...
            catch (MySqlException e)
            {
                if (mustCloseConnection)
                    connection.Close();
                throw new Exception(string.Format(e.ToString() + " {0}", commandText));
            }
        }

        /// <summary>执行指定数据库连接字符串的数据阅读器.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接字符串的数据阅读器,指定参数.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接字符串的数据阅读器,指定参数值.
        /// </summary>
        /// <remarks>
        ...
        public static MySqlDataReader ExecuteReader(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            {
                throw new Exception(string.Format(e.ToString() + " {0}", spName));
            }
        }
        ...
        /// <summary>[调用者方式]执行指定数据库连接对象的数据阅读器,指定参数.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>[调用者方式]执行指定数据库连接对象的数据阅读器,指定参数值.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值参数.
        /// 示例:  
        ...
        /// <summary>[调用者方式]执行指定数据库事务的数据阅读器,指定参数值.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>[调用者方式]执行指定数据库事务的数据阅读器,指定参数.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        {
            if (transaction == null) throw new ArgumentNullException("事务对象为空");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("事务已回滚或提交,请提供已打开的事务.", "事务异常");
        ...
        /// <summary>执行指定数据库连接字符串的命令,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接字符串的命令,指定参数,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接字符串的命令,指定参数值,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值参数.
        /// 
        ...
        /// <summary>执行指定数据库连接对象的命令,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接对象的命令,指定参数,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接对象的命令,指定参数值,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值参数.
        /// 
        ...
        /// <summary>执行指定数据库事务的命令,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库事务的命令,指定参数,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库事务的命令,指定参数值,返回结果集中的第一行第一列.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值参数.
        /// 
        ...
        /// <summary>执行指定数据库连接字符串的命令,映射数据表并填充数据集.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        {
            if (string.IsNullOrEmpty(connectionString)) throw new ArgumentNullException("数据库连接串为空");
            if (dataSet == null) throw new ArgumentNullException("DataSet数据集对象为空");
        ...
        /// <summary> 执行指定数据库连接字符串的命令,映射数据表并填充数据集.指定命令参数.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接字符串的命令,映射数据表并填充数据集,指定存储过程参数值.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值参数.
        /// 
        ...
        /// <summary>执行指定数据库连接对象的命令,映射数据表并填充数据集.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary> 执行指定数据库连接对象的命令,映射数据表并填充数据集,指定参数.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库连接对象的命令,映射数据表并填充数据集,指定存储过程参数值.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值参数.
        /// 
        ...
        {
            if (connection == null) throw new ArgumentNullException("数据库连接对象为空");
            if (dataSet == null) throw new ArgumentNullException("DataSet数据集为空");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("存储过程为空");
        ...
        /// <summary>执行指定数据库事务的命令,映射数据表并填充数据集.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库事务的命令,映射数据表并填充数据集,指定参数.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定数据库事务的命令,映射数据表并填充数据集,指定存储过程参数值.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值参数.
        /// 
        ...
        /// <summary>[私有方法][内部调用]执行指定数据库连接对象/事务的命令,映射数据表并填充数据集,DataSet/TableNames/SqlParameters.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行数据集更新到数据库,指定inserted, updated, or deleted命令.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ///  UpdateDataset(connection,insertCommand, deleteCommand, updateCommand, dataSet, "Order");
        /// </remarks>
        /// <param name="connection">一个有效的数据库连接对象</param>
        ...
        public static void UpdateDataset(MySqlConnection connection, MySqlCommand insertCommand, MySqlCommand deleteCommand, MySqlCommand updateCommand, DataSet dataSet, string tableName)
        {
            ...
            using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter("SELECT TOP 1 * FROM " + tableName, connection))
            {
                // 设置数据适配器命令
        ...
        /// <summary>创建MySqlCommand命令,指定数据库连接对象,存储过程名和参数.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>执行指定连接数据库连接字符串的存储过程,使用DataRow做为参数值,返回受影响的行数.
        /// </summary>
        /// <param name="connectionString">一个有效的数据库连接字符串</param>
        /// <param name="spName">存储过程名称</param>
        ...
        /// <summary>执行指定连接数据库连接对象的存储过程,使用DataRow做为参数值,返回受影响的行数.
        /// </summary>
        /// <param name="connection">一个有效的数据库连接对象</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库事物的存储过程,使用DataRow做为参数值,返回受影响的行数.
        /// </summary>
        ...
        /// <summary>执行指定连接数据库连接字符串的存储过程,使用DataRow做为参数值,返回DataSet.
        /// </summary>
        /// <param name="connectionString">一个有效的数据库连接字符串</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库连接对象的存储过程,使用DataRow做为参数值,返回DataSet.
        /// </summary>
        /// <param name="connection">一个有效的数据库连接对象</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库事务的存储过程,使用DataRow做为参数值,返回DataSet.
        /// </summary>
        /// <param name="transaction">一个有效的连接事务 object</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库连接字符串的存储过程,使用DataRow做为参数值,返回DataReader.
        /// </summary>
        /// <param name="connectionString">一个有效的数据库连接字符串</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库连接对象的存储过程,使用DataRow做为参数值,返回DataReader.
        /// </summary>
        /// <param name="connection">一个有效的数据库连接对象</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库事物的存储过程,使用DataRow做为参数值,返回DataReader.
        /// </summary>
        /// <param name="transaction">一个有效的连接事务 object</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库连接字符串的存储过程,使用DataRow做为参数值,返回结果集中的第一行第一列.
        /// </summary>
        /// <param name="connectionString">一个有效的数据库连接字符串</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库连接对象的存储过程,使用DataRow做为参数值,返回结果集中的第一行第一列.
        /// </summary>
        /// <param name="connection">一个有效的数据库连接对象</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>执行指定连接数据库事务的存储过程,使用DataRow做为参数值,返回结果集中的第一行第一列.
        /// </summary>
        /// <param name="transaction">一个有效的连接事务 object</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataRow">使用DataRow作为参数值</param>
        ...
        /// <summary>检验数据是否存在
        /// </summary>
        /// <param name="selectCommand">有效的查询字符串</param>
        /// <param name="transaction">有效的数据库连接对象</param>        
        /// <returns>bool</returns>
        public static bool ExecuteExists(string selectCommand, MySqlTransaction transaction)
        {

            bool flag = false;
            try
            {
                MySqlDataReader dr = ExecuteReader(transaction, CommandType.Text, selectCommand);
                flag = dr.HasRows;
                dr.Close();
                return flag;
            }
            ...
            {
                throw new Exception(string.Format(e.ToString() + " {0}", selectCommand));
            }
        }
    }
}