...
namespace cis_business.biz.clinicar
{
    public class ClinicarCheckItemBiz : SBaseBiz
    {
        ...
        {
            List<object> listParam = new List<object>();
            String sql = " Select distinct id,deleted,check_id,item_code,item_name,dpt_code,dpt_name,completed,canceled,summary,ifnull(conclusion,'') as conclusion,ifnull(advice,'') as advice From t_clinicar_check_item ";
