...
{
    public partial class FrmClinicarAllCheckDiseaseManage : SCommon.SControl.SBaseForm
    {
        ...
        public FrmClinicarAllCheckDiseaseManage()
        {
            InitializeComponent();
        }
        ...
        private void FrmClinicarDptManage_Load(object sender, EventArgs e)
        {
            ...
            {
                this.ucRic_remark.Text = strDisease;
            }
        }
        ...
        {
            this.DataEntity.Disease = this.ucRic_remark.Text;
            this.DataEntity.CheckNumber = checkNumber;
            this.DataEntity.Advice = this.strAdvice;
        }
        ...
        {
            this.ucRic_remark.Text = this.DataEntity.Disease;
        }
    }
}
